                    ...
                    <div class="md-card-content">
                        <h3 class="heading_b uk-margin-bottom">
                            ...
                            <div class="uk-float-right">
                                <a href="{{ route('admin::slidersetting.index') }}" class="md-btn md-btn-primary">List of slider</a>
                                {{-- @if(isset($post))
                        ...
                        <div class="uk-form-row">
                            <div class="uk-grid" data-uk-grid="{gutter:24}">
                                <div class="uk-width-1-1">
                                    <label>Title</label>
                                    {{ Form::text( 'title', old('title'), [ 'id' => 'title', 'class' => 'md-input', 'required' ] ) }}
                                </div>
                                  <div class="uk-width-1-1">
                                    <label>Slug</label>
                                ...
                                <div class="uk-width-1-1">
                                    <label>Caption</label>
                                    {{ Form::text( 'caption', old('caption'), [ 'id' => 'caption', 'class' => 'md-input', 'required' ] ) }}
                                </div>      
                                <div class="uk-width-1-1">
                                    <label>Url</label>
