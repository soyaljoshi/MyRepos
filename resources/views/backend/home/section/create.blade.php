...
@section('content')
    <div id="page_content">
        <div id="page_content_inner">
            {{ Form::open([ 'route' => 'admin::homesectionsetting.store', 'class' => 'uk-form-stacked', 'id' => 'page_create_form', 'files'=>'true' ]) }}
                @include('backend.home.section.partials.form', [ 'title' => 'Create Section' ])
            {{ Form::close() }}
        </div>
    </div>
@stop
