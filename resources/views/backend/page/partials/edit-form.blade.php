{{ Form::model($page, [ 'route' => [ 'admin::page.update', $page->slug ], 'id' => 'page_edit_form', 'method' => 'put','files'=>true ]) }}
            ...
            <div class="md-card-content">
                ...
                <div class="uk-grid">
                    <div class="uk-width-medium-1-2">
                        <div class="uk-form-row">
                            {{ Form::checkbox('is_draft', 1, old('is_draft'), [ 'id' => 'page_is_published', 'data-switchery' ] ) }}
            ...
            <div class="md-card-content">
                <div class="uk-grid" data-uk-grid-margin="10">
                    <div class="uk-width-1-1">
                        ...
                        @if(isset($page) && ! is_null($page->image))
                            <input type="file" name="image" id="image_file" class="dropify" data-default-file="{{ asset($page->image->thumbnail(260,198)) }}" />
                        @else
