...
<!--<![endif]-->
    <head>
        ...
        <link href="{{ asset('assets/backend/css/fileinput.css') }}" media="all" rel="stylesheet" type="text/css" />
    ...
    <body class="sidebar_main_open sidebar_main_swipe">
        ...
        <script src="{{ asset('assets/backend/js/common.min.js') }}"></script>
           {{-- <script src="{{ asset('assets/backend/js/custom/ckeditor_config.min.js') }}"></script> --}}
