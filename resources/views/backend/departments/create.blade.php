...
@section('content')
    <div id="page_content">
        <div id="page_content_inner">
            {{ Form::open([ 'route' => 'admin::departments.store', 'class' => 'uk-form-stacked', 'id' => 'page_create_form' ,'files' => 'true']) }}
                @include('backend.departments.partials.form', [ 'title' => 'Create Departments' ])
            {{ Form::close() }}
        </div>
    </div>
@stop
