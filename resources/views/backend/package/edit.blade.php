...
@section('content')
    <div id="page_content">
        <div id="page_content_inner">
            {{ Form::model($package, [ 'route' => ['admin::packages.update', $package->id], 'class' => 'uk-form-stacked', 'id' => 'package_create_form', 'files' => true, 'method' => 'PUT' ]) }}
                @include('backend.package.form', [ 'title' => 'Edit package' ])
            {{ Form::close() }}
        </div>
    </div>
@stop
