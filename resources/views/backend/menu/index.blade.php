...
@section('content')
    ...
    <div id="page_content">
        <div id="page_content_inner">
            <h3 class="heading_b uk-margin-bottom">Menu Management</h3>
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-5-5">
                    <button class="md-btn md-btn-primary button-menu-select primary-menu" data-add-target="#primary-menu-list" type="button">
                        <i class="material-icons">&#xE145;</i> Add Menu
                    </button>
            ...
            <div class="uk-accordion" data-uk-accordion="{ collapse: true }">
                <div class="menu-item">
                    ...
                    <div class="uk-accordion-content" data-id="acc-page">
                        ...
                        <div class="uk-grid data-uk-grid-margin">
                            <div class="uk-width-1-1 menu-type-col">
                                <div class="uk-form-stacked">
                                    <label class="uk-form-label">Select Category</label>
                                    {{ Form::select('menu-type', $menulist, 0, ['class' => 'menu-type', 'kendo-combo-box']) }}
                                </div>
                            </div>
                        </div>
                        <div class="uk-grid data-uk-grid-margin">
                    ...
                    <div class="uk-accordion-content" data-id="acc-custom">
                        ...
                        <div class="uk-grid uk-grid-margin">
                            <div class="uk-width-1-1 menu-type-col">
                                <div class="uk-form-stacked">
                                    <label class="uk-form-label">Select Category</label>
                                    {{ Form::select('menu-type', $menulist, null, ['class' => 'menu-type', 'kendo-combo-box']) }}
                                </div>
                            </div>
                        </div>
                        <div class="uk-grid uk-grid-margin">
    ...
    $(document).ready(function () {
        ...
        var menuTemplate = {
            0: `<div class="bl-accordion-item">
                    <h3 class="uk-accordion-title">
                        <input type="hidden" value="{parent_id}" name="{target}[{id}][parent_id]">
        ...
        $.each(existingMenus, function (k, v) {
            var menuTemplateClone = menuTemplate[0]
                ...
                .replaceAll('{id}', v.id)
                .replaceAll('{parent_id}',v.parent_id);
